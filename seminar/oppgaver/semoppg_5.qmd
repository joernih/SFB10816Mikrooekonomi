...
# Oppgave 1: Markedsteori -- fullkommen konkurranse og monopol (Eksamen HVL, høsten 2023)
a.
<div class="sol">
...
#SETT INN FIGUR 3_fk HER
eks_fk <- paste0('figurer/eks_fk.png')
knitr::include_graphics(eks_fk)
```
```{r, echo=FALSE, out.width="50%", fig.cap="",fig.align = 'center'}
#SETT INN FIGUR 3_fk HER
eks_mp <- paste0('figurer/eks_mp.png')
knitr::include_graphics(eks_mp)
```
# Oppgave 2: Spillteori
...
# Oppgave 3: Prisdiskriminering (HVL 202X)
<div class="sol">
