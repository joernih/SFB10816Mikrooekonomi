...
- Etterspørsel (MBV): $P = 20 – X$. Tilbud (GK): $P = 2 + 2X$
  ...
  a. Regn ut KO, PO og SO.
  a. Det innføres en skatt på 3 kroner per produserte enhet. Sett opp ny tilbudsfunksjon og regn ut $P_K$ (pris til konsument), $P_P$ (pris til produsent) og omsatt kvantum $X$.
  a. Hva blir KO, PO nå?
  a. Regn ut avgiftsinntekten for staten og effektivitetstapet (antar her at skatteinntektene blir
...
{{< video https://www.youtube.com/watch?v=R5Gppi-O3a8 >}}

**Friedman om prismekanismen (lengre versjon)**

{{< video https://www.youtube.com/watch?v=4ERbC7JyCfU&t=3s >}}
...
#| label: figur11.1
#| fig-cap: "Figur 11.1"
markedsformer <- paste0(rprojroot::find_rstudio_root_file(),'/forelesninger/drawio/markedsf.png')
...
#| label: figur11.2
#| fig-cap: "Figur 11.2"
cournot <- paste0(rprojroot::find_rstudio_root_file(),'/forelesninger/drawio/cournotl.png')
...
#| label: figur11.3
#| fig-cap: "Figur 11.3"
stackberg <- paste0(rprojroot::find_rstudio_root_file(),'/forelesninger/drawio/stackbergl.png')
...
#| label: figur11.4
#| fig-cap: "Figur 11.4"
bertrandl <- paste0(rprojroot::find_rstudio_root_file(),'/forelesninger/drawio/bertrandl.png')
...
#| label: figur11.5
#| fig-cap: "Figur 11.5"
monk_ks <- paste0(rprojroot::find_rstudio_root_file(),'/forelesninger/drawio/monk_ks.png')
...
#| label: figur11.6
#| fig-cap: "Figur 11.6"
monk_ls <- paste0(rprojroot::find_rstudio_root_file(),'/forelesninger/drawio/monk_ls.png')
...
#| label: figur15.1
#| fig-cap: "Figur 15.1"
ov_arbm <- paste0(rprojroot::find_rstudio_root_file(),'/forelesninger/drawio/oppg_arbm.png')
...
- Vurdert fra periode 2, kan den intertemporale budsjettbetingelsen skrives som 
$$
...
**Komparativ statikk: Økning i framtidig inntekt**

```{r, echo=FALSE, out.width="55%", fig.cap=""}
#| label: figur18.5
#| fig-cap: "Figur 18.5"
knitr::include_graphics("drawio/int_tilpasning_inntokning.png")
```
...
> En endring i allokering av gode som fører til at noen får det bedre (økt nytte/økt fortjenteste) uten at andre får det værre (redusert nytte/redusert fortenste) .
...
#| label: figur13.1
#| fig-cap: "Figur 13.1"
knitr::include_graphics(c("drawio/produ_eff.png")[1])
```
:::
...
#| label: figur13.3
#| fig-cap: "Figur 13.3"
knitr::include_graphics(c("drawio/bytte_eff.png"))
```
:::
::: {.column width="50%"}
Markedsøkonomi:<br> 
...
#| label: figur13.4
#| fig-cap: "Figur 13.4"
knitr::include_graphics("drawio/bytte_eff_m.png")
```
:::
::::
...
[Illustrerende eksempel: Israeli company converts passenger planes to cargo](https://www.i24news.tv/en/news/israel/economy/1645636837-israeli-company-converts-passenger-planes-to-cargo)
...
#| label: figur13.7
#| fig-cap: "Figur 13.7"
knitr::include_graphics(c("drawio/eks_mrk.png")[1])
```
...
```{r, echo=FALSE, out.height="45%", fig.cap=""}
#| label: figur13.10
#| fig-cap: "Figur 13.10"
