...
```{r, eval=T, echo=F}
kableExtra::kbl(df_t) %>% kableExtra::kable_paper(full_width = F) %>% kableExtra::kable_styling(font_size=24)
```
...
```{r, eval=T, echo=F}
kableExtra::kbl(df_o) %>% kableExtra::kable_paper(full_width = F) %>% kableExtra::kable_styling(font_size=24)
```
