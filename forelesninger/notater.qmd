...
subtitle: "Forelesningsnotater (o for oversiksbilde)"
...
<!--![](drawio/alternativ.svg){width=300} -->
...
grid.arrange(p_3_d1[[1]],p_3_d2[[1]],nrow = 1,top='+')
```
...
#knitr::include_graphics(p1)
grid.arrange(p_3_s1[[1]],p_3_s2[[1]],nrow = 1)
```
...
p_3_sd
```
- Merk: Ingenting i modellen som tilsier stabilitet. Men utenfor modellen kan vi resonnere omkring markedskrefter, slik de er beskrevet av Adam Smith.

---

- Anta at prisen er *under* enn likevektspris (makspris).
...
```{r, echo=FALSE, out.width="40%", fig.cap=""}
#prodo <- paste0(rprojroot::find_rstudio_root_file(),'/forelesninger/drawio/mfk_so.png')
#knitr::include_graphics(prodo)
p_3_kopo
```
