...
# Kapittel 4, 5 og 6: Produksjonsteori på kort sikt `r #paste(substring(del[2],4),tema[2])`
...
# Kapittel 4, 5 og 6: Produksjonsteori på lang sikt  `r #paste(substring(del[2],4),tema[3])`
...
::: {.column width="50%"}
Lineær produksjonsteknologi (perfekte substitutter)
...
Generelt resultat: Etterspør mer (mindre) av den innsatsfaktoren som har blitt billigere (dyrere),
og den kvantative effekten her er sterkere på langt sikt enn på kort sikt pga. substitusjonsegenskapene mellom arbeidskraft og kapital.
...
Min $C=wN +rK$ gitt $x^0=f(K,N)$ gitt (beskrankning). Lagrange metode:
\begin{equation}
...
# Kapittel 7: Konsumentteori  `r #paste(substring(del[5],4),tema[4])`
...
1. Anta at $u(x_1,x_2) = 10x_1x_2$. Finn uttrykket for MSB.
...
2. Beregn nyttenivået, vis og illustrer inndifferenskurven for de tre verdiene nedenfor:
...
**Øvelse**: 
Hva skjer dersom vi kun velger $x_2$?
...
# Kapittel 8: Konsumentens økonomiske adferd i gode- og arbeidsmarkedet `r #paste(substring(del[5],4),tema[5])`
