...
# Timeplan
ukr <- c(2,3,4,5,7,9,10,11,12,14,15,16,17)
dnr <- 3
ynr <- 2024
...
# Regneverksted
df_r <- data.frame(Kapittel=c(1,3:15))

#temaws <- c("Bedriftens tilpasning","Konsumentens tilpasning","Fullkommen konkurranse, monopol. offentlig økonomi og spilleteori")
#df3 <- data.frame(
#Antall=c(1,2,3), 
#Tema=temaws, 
#Dag=c("Fre","Fre","Tor"), 
#Ukenr=c(7,12,20), 
#star=c("09:15-10:00 11:15-12:00","09:15-10:00 11:15-12:00","09:15-12:00"), 
#Sted=c(rep("Aud. 3",2),"Aud. 2")
#)
