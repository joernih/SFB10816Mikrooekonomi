...
set pyxversion=3
set ruler
set runtimepath=~/.vim,~/.vim/plugged/AutoComplPop,~/.vim/plugged/vimtex,~/.vim/plugged/fzf,~/.vim/plugged/Nvim-R,~/.vim/plugged/vim-floaterm,~/.vim/plugged/translate-shell.vim,~/.vim/plugged/vim-hug-neovim-rpc,~/.vim/plugged/UltiSnips,~/.vim/plugged/ncm2-ultisnips,~/.vim/plugged/Vundle.vim,~/.vim/plugged/vim-matlab,~/.vim/plugged/vim-orgmode,~/.vim/plugged/popup.nvim,~/.vim/plugged/plenary.nvim,/usr/share/vim/vimfiles,/usr/share/vim/vim82,/usr/share/vim/vimfiles/after,~/.vim/after,~/.vim/plugged/vimtex/after,~/.vim/plugged/translate-shell.vim/after,~/.vim/plugged/UltiSnips/after,~/.vim/bundle/Vundle.vim
set shell=zsh
set statusline=%F
...
silent only
silent tabonly
cd ~/teaching/SFB10816Mikrooekonomi
...
$argadd index.Rmd
edit index.Rmd
tcd ~/teaching/SFB10816Mikrooekonomi
argglobal
balt ~/teaching/SFB10816Mikrooekonomi/inst/oppgaver/Regneverksted3_losning.Rmd
...
silent! normal! zE
let &fdl = &fdl
let s:l = 97 - ((32 * winheight(0) + 28) / 57)
...
normal! 0
tabnext 1
badd +1 ~/teaching/SFB10816Mikrooekonomi/index.Rmd
badd +11 ~/teaching/SFB10816Mikrooekonomi/inst/oppgaver/Regneverksted3_losning.Rmd
